...
public class ChoiNgayVong2 extends AppCompatActivity {
    ...
    private void checkvong(int id) {
        ...
        Listvong2.clear();
        Cursor cursor = MainActivity.database.Getdata("SELECT VONG,SOSAO FROM VONGCHINH WHERE VONG >2 AND VONG <3 AND  IDTK  = " + id);
...
//                @Override
//                public void onClick(View view) {
//                    Toast.makeText(ChoiNgayVong2.this, " qua vòng 2 ", Toast.LENGTH_SHORT).show();
//                    startActivity(new Intent(ChoiNgayVong2.this, ChoiNgayVong2.class));
//                }
//            });
        }catch (Exception e){
